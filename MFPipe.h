...
public:
    ...
    virtual HRESULT PipePut( /*[in]*/ const std::string &strChannel, /*[in]*/ const REF_getter<MF_BASE_TYPE> &pBufferOrFrame, /*[in]*/ int _nMaxWaitMs, /*[in]*/ const std::string &strHints) = 0;
    virtual HRESULT PipeGet( /*[in]*/ const std::string &strChannel, /*[out]*/ REF_getter<MF_BASE_TYPE> &pBufferOrFrame, /*[in]*/ int _nMaxWaitMs, /*[in]*/ const std::string &strHints) = 0;
    virtual HRESULT PipePeek( /*[in]*/ const std::string &strChannel, /*[in]*/ int _nIndex, /*[out]*/ REF_getter<MF_BASE_TYPE>& pBufferOrFrame, /*[in]*/ int _nMaxWaitMs, /*[in]*/ const std::string &strHints) = 0;
